...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
void transform(vector<Vec3d> &laserScanXY, vector<Vec3d> &laserScanXYAfter, double x, double y, double theta)
{
    Vec3d newPt;
    double cosTheta = cos(theta);
    double sinTheta = sin(theta);
...
void drawLRFScan(Mat &display, vector<Vec3d> &laserScanXY, double dMaxDist, Scalar color)
{
    Vec2i imageHalfSize = Vec2i(display.cols/2, display.rows/2);
    int nRangeSize = (int)laserScanXY.size();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
void printOdometryInfo(nav_msgs::Odometry &odom)
{
    // Display /odom part!
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
Mat EulerToMatrixCCW(double dRx, double dRy, double dRz, bool bIsDegree)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Matrix -> Euler
void MatrixToEulerCCW(cv::Mat &mat, double &dRx, double &dRy, double &dRz, bool bIsDegree)
{
    // RPY Euler angle (roll->pitch->yaw) 순서를 따르는 회전 행렬
    // roll = z축 회전
    // pitch = y축 회전
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
Mat getRelativeRt(nav_msgs::Odometry &odomPrev, nav_msgs::Odometry &odomCrnt)
{
    // 변수선언
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
void PrintLaserScanInfo(char *pMsg, sensor_msgs::LaserScan &scan, bool bUseDegree)
{
    if(bUseDegree) {
        printf("%s", pMsg);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
bool DrawPolarScan(Mat &display, sensor_msgs::LaserScan &scan, Scalar color, bool bClear, int nOffset)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
bool DrawCartesianScan(Mat &display, sensor_msgs::LaserScan &scan, Scalar color, bool bClear, int nOffset)
{
    int nSize = (int) scan.ranges.size();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
Mat getWorldRt(nav_msgs::Odometry &odom)
{
    // 변수선언
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
Mat DoPolarRegistration(sensor_msgs::LaserScan &prevPolar, sensor_msgs::LaserScan &crntPolar, float fAngleSearchRange)
{
    /////////////////////////////////////////////////////////////////////////////////////////////
    // 환경변수
...
int transformRelativeRT(Mat Rt,sensor_msgs::LaserScan &currScan)
{
